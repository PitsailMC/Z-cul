...
import pitsail.zcul.api.ModLoader;
    ...
    protected void init() {
        ...
        if (player.getName().getString().equals("Dev")) {
            addConfigButton(() -> CullingStateManager.checkCulling, (b) -> CullingStateManager.checkCulling = b, () -> Component.literal("Debug"))
                    .setDetailMessage(() -> Component.translatable("zcul.detail.debug"));

            addConfigButton(() -> CullingStateManager.checkTexture, (b) -> CullingStateManager.checkTexture = b, () -> Component.literal("Check Texture"))
                    .setDetailMessage(() -> Component.translatable("zcul.detail.check_texture"));
        }
        ...
        addConfigButton(Config::getSampling, (value) -> {
            ...
            return format;
        }, (value) -> String.valueOf(Mth.floor(value * 100) + "%"), () -> Component.translatable("zcul.sampler"))
                .setDetailMessage(() -> Component.translatable("zcul.detail.sampler"));
        ...
        }, () -> Component.translatable("zcul.culling_map_update_delay"))
                .setDetailMessage(() -> Component.translatable("zcul.detail.culling_map_update_delay"));

        addConfigButton(Config::getAutoDisableAsync, Config::setAutoDisableAsync, () -> Component.translatable("zcul.auto_shader_async"))
                .setDetailMessage(() -> Component.translatable("zcul.detail.auto_shader_async"));

        addConfigButton(() -> Config.getCullChunk() && ModLoader.hasSodium() && !ModLoader.hasNvidium(), Config::getAsyncChunkRebuild, Config::setAsyncChunkRebuild, () -> Component.translatable("zcul.async"))
                .setDetailMessage(() -> {
                    if (ModLoader.hasNvidium()) {
                        return Component.translatable("zcul.detail.nvidium");
                    } else if (!ModLoader.hasSodium()) {
                        return Component.translatable("zcul.detail.sodium");
                    } else
                        return Component.translatable("zcul.detail.async");
                });
        addConfigButton(Config::getCullChunk, Config::setCullChunk, () -> Component.translatable("zcul.cull_chunk"))
                .setDetailMessage(() -> Component.translatable("zcul.detail.cull_chunk"));
        addConfigButton(Config::getCullBlockEntity, Config::setCullBlockEntity, () -> Component.translatable("zcul.cull_block_entity"))
                .setDetailMessage(() -> {
                    if (CullingStateManager.gl33()) {
                        return Component.translatable("zcul.detail.cull_block_entity");
                    } else {
                        return Component.translatable("zcul.detail.gl33");
                    }
                });
        addConfigButton(Config::getCullEntity, Config::setCullEntity, () -> Component.translatable("zcul.cull_entity"))
                .setDetailMessage(() -> {
                    if (CullingStateManager.gl33()) {
                        return Component.translatable("zcul.detail.cull_entity");
                    } else {
                        return Component.translatable("zcul.detail.gl33");
                    }
                });
